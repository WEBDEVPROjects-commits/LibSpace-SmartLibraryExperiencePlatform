  ...
  <div className="w-full max-w-md p-8">
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
      ...
      <form className="space-y-5">
        ...
        >
        <Link to={(localStorage.getItem("email"==props.email)) && (localStorage.getItem("password"==props.password))?"/Dashboard":"/Login"}>Sign in</Link>
        </button>
      </form>
      ...
      <button className="w-full border border-gray-200 py-3 rounded-lg font-medium text-gray-700 hover:bg-gray-50 transition duration-200 flex items-center justify-center gap-2">
